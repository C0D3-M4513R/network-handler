...
use network_handler::handlers::osc::raw_packet_handler::RawPacketHandler as OscRawPacketHandler;

const DEFAULT_ALLOC:usize = 1024;

///Allows for sending OSC Messages
pub struct OscReceiver<I1, I2, I3> {
    osc_recv:std::sync::Arc<UdpSocket>,
...
osc_receiver_listen!(listen_recv_from, core::net::SocketAddr, tokio::net::UdpSocket::recv_buf_from, core::convert::identity);
osc_receiver_listen!(listen_recv, &'static str, tokio::net::UdpSocket::recv_buf, |v:Result<usize, std::io::Error>|v.map(|v|(v, "")));
macro_rules! osc_receiver_listen {
...
> OscReceiver<H1, H2, H3> {
    pub async fn $name<
        CheckFut:core::future::Future<Output = ()> + Send + 'static,
